...
JNIEXPORT void JNICALL Java_at_favre_app_blurbenchmark_blur_algorithms_NdkStackBlur_functionToBlur(JNIEnv* env, jclass clzz __attribute__((__unused__)), jobject bitmapOut, jint radius, jint threadCount, jint threadIndex, jint round) {
    // Properties
