...
public class BenchmarkResultHolder extends RecyclerView.ViewHolder {
	...
	public BenchmarkResultHolder(View itemView,FragmentManager fragmentManager) {
		...
		tvBlurRadius = (TextView) itemView.findViewById(R.id.tv_radius);
		tvWidthHeight = (TextView) itemView.findViewById(R.id.tv_width_height);
		tvImageInfo = (TextView) itemView.findViewById(R.id.tv_imageInfo);
		imageView = (ImageView) itemView.findViewById(R.id.thumbnail);
		tvDeviation = (TextView) itemView.findViewById(R.id.tv_deviation);
		tvErrMsg = (TextView) itemView.findViewById(R.id.tv_errMsg);
		tvAdditionalInfo = (TextView) itemView.findViewById(R.id.tv_algorithm);
		tvOver16ms = (TextView) itemView.findViewById(R.id.tv_over16ms);
		frontImageWrapper = (FrameLayout) itemView.findViewById(R.id.thumbnail_front);
		backImageWrapper = (FrameLayout) itemView.findViewById(R.id.thumbnail_back);
	}
